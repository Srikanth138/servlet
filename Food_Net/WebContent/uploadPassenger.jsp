...
<%@page import="com.nit.beans.TaxiDriverBean"%>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 pr-md-5">
				<form action="UploadPassenger" method="get">
					<h3>
						<font color='red'><b><u>Passenger Details:</u></b></font>
					</h3>
					<br />
					<div class="row">

						<div class="col-md-4 form-group">
							<label for="email">Select Taxi</label> <select
								class="form-control py-2" name="taxiId" required>
								<%
                      UserDAO dao=new UserDAO();
                      List<TaxiDriverBean> list=dao.getTaxiDrivers();
                      if(!list.isEmpty() && list.size()>0)
                      {
                      for(TaxiDriverBean tb:list)
                      {
						%>
                       ...
                       %>
						...
						<div class="col-md-4 form-group">
							<label for="phone">Source Location</label> <select name="source"
								class="form-control py-2" required>
								<%
                      TreeSet<String> li=dao.getLocations();
                      ...
                      %>
                       ...
                       %>
						...
						<div class="col-md-4 form-group">
							<label for="email">Destinatin Location</label> <select
                      ...
                      %>
                       ...
                       %>
						...
						<div class="col-md-4 form-group">
							<label for="email">Pickup Time</label> <input type="text"
								name="pickup" placeholder="09:10 AM" class="form-control py-2"
								required>
						</div>
