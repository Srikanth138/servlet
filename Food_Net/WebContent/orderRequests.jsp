...
<section class="site-section element-animate">
	<div class="container">
		...
		<%
			...
			List<RestaurantBean> list=dao.getOrders();
		...
		<table class="table">
			...
			{
			i++;
			List<Integer> taxiIdList=dao.checkTaxiAvailability(rb);
			session.setAttribute("taxiList"+i,taxiIdList);
			%>
			<tr>
				<td><%=rb.getFood() %></td>
				...
				<%
			if(taxiIdList.size()>0)
			{
			 %>
				<td><a href="ViewAvailableTaxis.jsp?i=<%=i %>"><button
							type="buttong" class="btn btn-success btn-sm">Available</button></a></td>
				<%
			}
			else
			{
			 %>
				<td><a href="createOwnTaxi.jsp?i=<%=i %>"><button
							type="buttong" class="btn btn-danger btn-sm">Own Vehicle</button></a></td>
				<%
			}
			 %>
			</tr>
