...
<%@page import="com.nit.beans.PassengerBean"%><jsp:include
...
<section class="site-section element-animate">
	<div class="container">
		...
		<%
			...
			List<PassengerBean> list=dao.viewPassengers();
		...
		<table class="table">
			...
			<%
			for(PassengerBean rb:list)
			{
			%>
			<tr>
				<td><%=rb.getName() %></td>
				<td><%=rb.getSourceLocation() %></td>
				<td><%=rb.getDestinationLocation()%></td>
				<td><%=rb.getPickUpTime()%></td>
			</tr>
			<%
			}
			}
