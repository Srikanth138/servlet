	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 pr-md-5">
				<form action="UploadRestaurant" method="post"
					enctype="multipart/form-data">
					<h3>
						<font color='red'><b><u>Restaurant Details:</u></b></font>
					</h3>
					<br />
					...
					<div class="row">
						...
						<div class="col-md-4 form-group">
							...
							<label for="email">Restaurant Name</label> <input type="text"
								name="restaurantName" class="form-control py-2" required>
						</div>
						<div class="col-md-4 form-group">
						...
						<div class="col-md-4 form-group">
							<label for="email">Email</label> <input type="email" name="email"
								title="ex:rambabu@gmail.com" class="form-control py-2" required>
						</div>
					...
					<div class="row">
						<div class="col-md-4 form-group">
							<label for="phone">Location</label> <select name="location"
								class="form-control py-2" required>
								<%
                      ...
                      %>
                       ...
                       %>
						...
						<div class="col-md-4 form-group">
							<label for="phone">Business Hours</label> <input type="text"
								name="hours" class="form-control py-2" required>
						</div>
						<div class="col-md-4 form-group">
							<label for="email">Food</label> <input type="text" name="food"
								class="form-control py-2" required>
						</div>
						<div class="col-md-4 form-group">
							<label for="email">Price</label> <input type="number"
								name="price" class="form-control py-2" required>
						</div>
					...
					<div class="row">
						<div class="col-md-12 form-group">
							<label for="message">Image</label> <input type="file"
								name="image" class="form-control py-2" required />
							<!--
