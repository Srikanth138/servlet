	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 pr-md-5">
				<form action="UploadTaxiDriver" method="get">
					<h3>
					...
					<div class="row">
						...
						<div class="col-md-4 form-group">
							<label for="email">Location</label> <select name="location"
								class="form-control py-2" required>
								<%
                       ...
                       %>
						...
						<div class="col-md-4 form-group">
							<label for="email">Pickup Time</label> <input type="text"
								name="pickUp" placeholder="10:10" class="form-control py-2"
								required>
						</div>
						<div class="col-md-4 form-group">
							<label for="email">Drop Time</label> <input type="text"
								name="dropTime" placeholder="14:10" class="form-control py-2"
								required>
						</div>
					</div>
